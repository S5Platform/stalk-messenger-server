        ...
        for (key in _users) {
          if (!_users[key]) {
            ...
            if( backgrounds[key] ) {
              ...
              client.get("G:"+key, function(err, reply) {
                ...
                if (err) {
                  ...
                  if( _users[key].deviceToken ){
                    if( _users[key].deviceType == 'ios' &&  apnProvider ){
                      ...
                      apnProvider.send(note, _users[key].deviceToken ).then( (result) => {
                        console.log( result );
                      });

                    } else if( _users[key].deviceType == 'android' &&  gcmProvider ){
                      ...
                      var regTokens = [_users[key].deviceToken];
