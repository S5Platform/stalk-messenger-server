...
ParseAdapter.prototype.get = function( parseObject ){
...
ParseAdapter.prototype.create = function( parseObject ){
  ...
  var data = parseObject._getSaveParams();
	...
	var write = new RestWrite(this.config, Auth.master(this.config), parseObject.className, null, data, null);
...
ParseAdapter.prototype.update = function( parseObject ){
  ...
  var data = parseObject._getSaveParams();
	...
	var write = new RestWrite(this.config, Auth.master(this.config), parseObject.className, {objectId: parseObject.id}, data, null);
	return write.execute();
}
