...
ParseAdapter.prototype.get = function( query ){
...
ParseAdapter.prototype.create = function( query ){
  ...
  for( var key in query ){
	...
	var write = new RestWrite(this.config, Auth.master(this.config), query.className, null, data, null);
	 return write.execute();
}

ParseAdapter.prototype.update = function( query ){
  ...
  for( var key in query ){
	...
	var write = new RestWrite(this.config, Auth.master(this.config), query.className, {objectId: query.objectId}, data, null);
	return write.execute();
}
